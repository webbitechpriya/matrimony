                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    <View style={styles.header}>
                        ...
                        <View style={{ padding: 10 }} >
                            ...
                            <Text style={[styles.title, { marginTop: 8, paddingBottom: 5 }]}>WEIGHT*</Text>
                            <View style={styles.selectList}
                            >
                                <Dropdown
                                    style={styles.dropdown}
                            ...
                            <Text style={[styles.lifeStyle, { marginTop: 8, paddingBottom: 5 }]}>LIFE STYLE INFORMATION</Text>

                            <Text style={[styles.title, { marginTop: 8, paddingBottom: 5 }]}>EATING HABITS</Text>
                            <View style={styles.selectList}
                            >
                                <Dropdown
                                    style={styles.dropdown}
                            ...
                            <Text style={[styles.title, { marginTop: 8, paddingBottom: 5 }]}>SMOKING HABITS*</Text>
                            <View style={styles.selectList}
                            >
                                <Dropdown
                                    style={styles.dropdown}
                            ...
                            <Text style={[styles.title, { marginTop: 8, paddingBottom: 5 }]}>DRINKING HABITS*</Text>
                            <View style={styles.selectList}
                            >
                                <Dropdown
                                    style={styles.dropdown}
                            ...
                            <View style={styles.genderText}>
                                ...
                                <View style={{ flex: 0.48 }}>
                                    <Text style={styles.DobStyle}>FATHER OCCUPATION*</Text>
                                    <Dropdown
                                        style={styles.dropdown}
                                        placeholderStyle={styles.placeholderStyle}
                                        selectedTextStyle={styles.selectedTextStyle}
                                ...
                                <View style={{ flex: 0.48 }}>
                                    <Text style={styles.DobStyle}>MOTHER OCCUPATION*</Text>
                                    <Dropdown
                                        style={styles.dropdown}
                                        placeholderStyle={styles.placeholderStyle}
                                        selectedTextStyle={styles.selectedTextStyle}
                    ...
                    <TouchableOpacity style={styles.nextButton} onPress={() => this.props.navigation.navigate('UploadPhoto')} >
                        <LinearGradient
                            start={{ x: 0.0, y: 0.25 }} end={{ x: 1.0, y: 1.25 }}
